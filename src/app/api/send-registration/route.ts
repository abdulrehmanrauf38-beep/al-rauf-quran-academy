...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!fullName || !email || !phone || !country || !course || !classesPerWeek || !studentAge) {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1c1917;">
          <div style="background: #0f3d2e; padding: 24px; border-radius: 8px 8px 0 0;">
            <h1 style="color: #f59e0b; margin: 0; font-size: 22px;">New Student Registration</h1>
          ...
          <div style="background: #ffffff; padding: 24px; border: 1px solid #e7e5e4; border-top: none; border-radius: 0 0 8px 8px;">
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr><td style="padding: 10px 0; border-bottom: 1px solid #f5f5f4; color: #78716c; font-size: 14px;"><strong>Course Interested In</strong></td><td style="padding: 10px 0; border-bottom: 1px solid #f5f5f4; font-size: 14px;">${course}</td></tr>
              <tr><td style="padding: 10px 0; border-bottom: 1px solid #f5f5f4; color: #78716c; font-size: 14px;"><strong>Classes per Week</strong></td><td style="padding: 10px 0; border-bottom: 1px solid #f5f5f4; font-size: 14px;">${classesPerWeek} classes/week</td></tr>
              ...
              <tr><td style="padding: 10px 0; color: #78716c; font-size: 14px; vertical-align: top;"><strong>Additional Notes</strong></td><td style="padding: 10px 0; font-size: 14px;">${notes || "None"}</td></tr>
            </table>
            <div style="margin-top: 24px; padding: 12px 16px; background: #f0fdf4; border-left: 4px solid #16a34a; border-radius: 4px;">
              <p style="margin: 0; font-size: 13px; color: #15803d;">⏰ Please contact this student within 24 hours to confirm enrollment and payment details.</p>
            </div>
          </div>
        </div>
      `,
    ...
    await resend.emails.send({
      from: FROM,
      to: email,
      subject: "Registration Received — Al Rauf International Quran Academy 🌙",
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1c1917;">
          ...
          <div style="background: #ffffff; padding: 32px 24px; border: 1px solid #e7e5e4; border-top: none; border-radius: 0 0 8px 8px;">
            ...
            <p style="color: #44403c; line-height: 1.7; margin: 0 0 16px;">
              Thank you for registering with <strong>Al Rauf International Quran Academy</strong>. We're delighted to welcome you to our growing family of students!
            </p>
            <div style="background: #fefce8; border: 1px solid #fde68a; border-radius: 8px; padding: 16px 20px; margin: 24px 0;">
              ...
              <p style="margin: 8px 0 0; color: #78350f; font-size: 14px; line-height: 1.6;">
                We've received your registration and will contact you within <strong>24 hours</strong> to confirm enrollment and payment details. Our team will reach out via email or WhatsApp.
              </p>
            </div>
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
              <tr style="background: #f5f5f4;"><td style="padding: 10px 12px; font-size: 13px; color: #78716c; width: 45%;"><strong>Course</strong></td><td style="padding: 10px 12px; font-size: 13px;">${course}</td></tr>
              <tr><td style="padding: 10px 12px; font-size: 13px; color: #78716c;"><strong>Classes per Week</strong></td><td style="padding: 10px 12px; font-size: 13px;">${classesPerWeek} classes</td></tr>
            </table>
